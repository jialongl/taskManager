...
\footnotetext{ *nix version can be run at any directory after installing taskManger -- \cmdinline{"make install"}. See details in section \cmdinline{"Compilation and Installation".}}
...
The text-based user interface adds \cmd{djsakl}.
...
Example: \cmd{> \ what do I do today?} All tasks due today will be listed out.    
...
In Unix-like operating systems like GNU Linux and Mac OS X, start a shell, change directory to taskManager's source folder and type: \cmd{\$ make\\
  \$ sudo make install}
