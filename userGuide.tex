...
%% %When the user requires viewing the tasks, it will output the required fields to the user.
%% \item Text User Interface

%% %This user interface provides an interactive interface between the user and the
...
%% These are the interfaces of the IO Module. It shows the  \cmdinline{IO Module} interacts with
...
\cmdinline{undo}, \cmdinline{redo} were implemented. 
