...
\begin{itemize}
\item \$0 Means all characters from current position
\item \$1, \$2, \$3 .... Means one token
\end{itemize}
...
{\bf Important: } TUI uses \texttt{ls} to retrieve tasks. Mapping \texttt{ls} to something else will affect behaviour of TUI.}
