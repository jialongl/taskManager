...
Take command \cmdinline{ls -k *Sam?le*task} as an example, ``This is a sample with an important task'' will match \cmdinline{*Sam?le*task} as the first * matches \cmdinline{"This is a "}, \cmdinline{?} matches \cmdinline{'p'} and the second * matches \cmdinline{" with an important "}.
