...
\mbox{\texttt{
  ...
  virtual void handleException(exception\_e except) \{\};
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{top-level-sequence-diagram}
\end{figure}

A more detailed sequence diagram inside the Logic:
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{sequence-diagram-inside-logic-part}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[scale=0.6]{sequence-diagram-inside-UI-part}
\end{figure}
